...
export function Testimonials({ onReadAloud }: TestimonialsProps) {
  ...
  return (
    <section id="testimonials" className="py-24 md:py-32 bg-ink text-parchment">
      <div className="max-w-7xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-16">
          <div className="manuscript-divider max-w-xs mx-auto mb-6">
            <span className="font-serif text-sm tracking-widest uppercase text-gold">Testimonium</span>
          </div>
          <h2 className="font-serif text-4xl md:text-5xl text-parchment mb-6">
            Words from Fellow Scribes
          </h2>
          <p className="font-sans text-lg text-parchment/70 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              ...
              className="relative p-8 bg-parchment/5 border border-parchment/10 group hover:bg-parchment/10 transition-colors"
            >
              {/* Quote Mark */}
              <div className="absolute top-6 left-6 text-gold/30 font-serif text-6xl leading-none">
                &ldquo;
              </div>
              
              {/* Content */}
              <div className="relative z-10 pt-8">
                <blockquote className="font-sans text-parchment/90 leading-relaxed mb-6 italic">
                  {testimonial.quote}
                </blockquote>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 text-xs text-parchment/50 hover:text-gold transition-colors mb-6"
                >
                ...
                <div className="border-t border-parchment/10 pt-4">
                  <div className="font-serif text-parchment">{testimonial.author}</div>
                  <div className="font-sans text-sm text-parchment/60">{testimonial.title}</div>
                  <div className="font-sans text-xs text-gold/70 mt-1">{testimonial.institution}</div>
                </div>
              </div>
        ...
        <div className="mt-20 pt-16 border-t border-parchment/10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="font-serif text-4xl md:text-5xl text-gold mb-2">4M+</div>
              <div className="font-sans text-sm text-parchment/60">Scribes Worldwide</div>
            </div>
            <div>
              <div className="font-serif text-4xl md:text-5xl text-gold mb-2">50B+</div>
              <div className="font-sans text-sm text-parchment/60">Words Preserved</div>
            </div>
            <div>
              <div className="font-serif text-4xl md:text-5xl text-gold mb-2">190+</div>
              <div className="font-sans text-sm text-parchment/60">Kingdoms Served</div>
            </div>
            <div>
              <div className="font-serif text-4xl md:text-5xl text-gold mb-2">99.9%</div>
              <div className="font-sans text-sm text-parchment/60">Archive Uptime</div>
            </div>
          </div>
        </div>
      </div>
